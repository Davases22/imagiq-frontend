...
// precargarlos todos gastaría datos del comprador en material que quizá no mire.
...
const ProductCarousel = forwardRef<HTMLDivElement, ProductCarouselProps>(({
  ...
  // Sin esto, cada foto empieza a descargarse recién en el momento en que el
  // comprador pasa a ella y el carrusel se queda vacío mientras llega. Los
  // videos se excluyen a propósito: pesan demasiado para traerlos de entrada.
  useEffect(() => {
